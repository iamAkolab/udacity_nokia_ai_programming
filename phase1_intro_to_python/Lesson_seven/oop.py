...
Object-oriented programs hide implementation from the end-userConsider Python package like scikit-learn, pandas, or numpy. 
These are all Python libraries built with object-oriented programming. 
