...
Knowing these topics is enough to start writing object-oriented software. What you've learned so far is all you need 
to know to complete this OOP lesson. However, these are only the fundamentals of object-oriented programming.
...
This article explains different types of methods that can be accessed at the class or object level.
